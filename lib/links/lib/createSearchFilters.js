...
export function createOne(object, fieldStorage) {
  const fieldStorageArray = fieldStorage.split('.');
  if (object[fieldStorageArray[fieldStorageArray.length-2]] && object[fieldStorageArray[fieldStorageArray.length-2]][fieldStorageArray[fieldStorageArray.length-1]]) {
    return {
      _id: object[fieldStorageArray[fieldStorageArray.length-2]][fieldStorageArray[fieldStorageArray.length-1]],
    };
  } else {
    return {
      _id: object[fieldStorageArray],
    };
  }
}
